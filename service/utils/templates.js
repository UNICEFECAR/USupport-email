  ...
  <head>
    ...
    <style>
      * {
      ...
      body[data-ogsc] .logo-shell-light,
      body[data-ogsb] .logo-shell-light,
      [data-ogsc] .logo-shell-light {
        display: none !important;
        max-height: 0 !important;
        overflow: hidden !important;
        mso-hide: all !important;
      }
      body[data-ogsc] .logo-light,
      body[data-ogsb] .logo-light,
      [data-ogsc] .logo-light {
        display: none !important;
      }
      body[data-ogsc] .logo-dark,
      body[data-ogsb] .logo-dark,
      [data-ogsc] .logo-dark {
        display: block !important;
      }
      body[data-ogsc] .mascot-light,
      body[data-ogsb] .mascot-light,
      [data-ogsc] .mascot-light {
        display: none !important;
      }
      body[data-ogsc] .mascot-dark,
      body[data-ogsb] .mascot-dark,
