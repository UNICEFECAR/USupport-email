export default {
  ...
  client_consultation_confirm_booking_text:
    "Вы успешно записались на консультацию. Посетите {1}, чтобы просмотреть подробности консультации.",

  client_consultation_confirm_reschedule_subject: "Перенос консультации",
  client_consultation_confirm_reschedule_title:
    "Подтверждение переноса консультации",
  client_consultation_confirm_reschedule_text:
    "Вы успешно перенесли консультацию. Посетите {1}, чтобы просмотреть новые сведения о консультации.",

  client_consultation_confirm_cancellation_subject: "Отмена консультации",
  ...
  client_consultation_confirm_cancellation_text:
    "Вы успешно отменили консультацию. Посетите {1}, чтобы запланировать новую консультацию.",

  client_consultation_notify_cancellation_subject: "Отмена консультации",
  client_consultation_notify_cancellation_title:
    "Консультация отменена консультантом",
  client_consultation_notify_cancellation_text:
    "Ваша консультация отменена консультантом. Посетите {1}, чтобы запланировать новую консультацию.",

  client_consultation_remind_start_subject: "Напоминание о консультации",
  client_consultation_remind_start_title: "Напоминание о консультации",
  client_consultation_remind_start_text:
    "Ваша консультация начнется через {2} минут(ы). Посетите {1}, чтобы присоединиться к консультации.",

  client_consultation_notify_suggestion_subject: "Предложение консультации",
  client_consultation_notify_suggestion_title: "Предложение новой консультации",
  client_consultation_notify_suggestion_text:
    "У Вас есть предложение о новой консультации. Посетите {1}, чтобы просмотреть дополнительные сведения.",
  ...
  client_consultation_confirm_suggestion_booking_text:
    "Вы успешно приняли предложенную консультацию. Посетите {1}, чтобы просмотреть подробности консультации.",
  ...
  client_consultation_confirm_suggestion_cancellation_title:
    "Подтверждение отказа от консультации",
  ...
  provider_consultation_notify_booking_title: "Запись на новую консультацию",
  provider_consultation_notify_booking_text:
    "У Вас новая запись на консультацию. Посетите {1}, чтобы просмотреть дополнительные сведения.",

  provider_consultation_notify_reschedule_subject: "Перенос консультации",
  provider_consultation_notify_reschedule_title: "Перенос консультации",
  ...
  provider_consultation_confirm_cancellation_text:
    "Вы успешно отменили консультацию.",

  provider_consultation_remind_start_subject: "Напоминание о консультации",
  provider_consultation_remind_start_title: "Напоминание о консультации",
  provider_consultation_remind_start_text:
    "Ваша консультация начнется через {2} минут(ы). Посетите {1}, чтобы присоединиться к консультации.",

  provider_consultation_confirm_suggestion_subject: "Предложение консультации",
  provider_consultation_confirm_suggestion_title:
    "Подтверждение предложенной консультации",
  provider_consultation_confirm_suggestion_text:
    "Вы успешно предложили консультацию. Посетите {1}, чтобы просмотреть дополнительные сведения.",

  provider_consultation_notify_suggestion_booking_subject:
    "Запись на консультацию",
  provider_consultation_notify_suggestion_booking_title:
    "Принятое предложение консультации",
  provider_consultation_notify_suggestion_booking_text:
    "Ваше предложение консультации было принято. Посетите {1}, чтобы просмотреть дополнительные сведения.",

  provider_consultation_notify_suggestion_cancellation_subject:
    "Отказ от консультации",
  provider_consultation_notify_suggestion_cancellation_title:
    "Отклонено предложение консультации",
  ...
  provider_availability_remind_add_more_slots_text:
    "Ваш последний слот доступности менее чем через неделю. Посетите {1}, чтобы добавить в свое расписание больше свободных слотов.",
