export default {
  ...
  system_login_2fa_request_title:
    "Екіфакторлы аутентификациялық (2FA) бір реттік құпия сөзбен (OTP) кіру",
  system_login_2fa_request_text:
    "Өз аккаунтыңызға кіру үшін осы кодты пайдаланыңыз",
  ...
  client_consultation_confirm_reschedule_text:
    "Сіз консультацияны басқа уақытқа сәтті ауыстырдыңыз. Консультация туралы жаңа мәліметтерді көру үшін {1} кіріңіз.",

  client_consultation_confirm_cancellation_subject: "Консультацияны болдырмау",
  client_consultation_confirm_cancellation_title:
    "Консультацияны болдырмауды растау",
  client_consultation_confirm_cancellation_text:
    "Сіз консультациядан сәтті бас тарттыңыз. Жаңа консультация жоспарлау үшін {1} кіріңіз.",

  client_consultation_notify_cancellation_subject: "Консультацияны болдырмау",
  client_consultation_notify_cancellation_title:
    "Консультацияны консультант алып тастады",
  client_consultation_notify_cancellation_text:
    "Сіздің консультацияңызды консультант алып тастады. Жаңа консультация жоспарлау үшін {1} кіріңіз.",

  client_consultation_remind_start_subject: "Консультация туралы еске салу",
  client_consultation_remind_start_title: "Консультация туралы еске салу",
  ...
  client_consultation_confirm_suggestion_booking_text:
    "Сіз ұсынылған консультацияны сәтті қабылдадыңыз. Консультация мәліметтерін көру үшін {1} кіріңіз.",

  client_consultation_confirm_suggestion_cancellation_subject:
    "Консультациядан бас тартты",
  client_consultation_confirm_suggestion_cancellation_title:
    "Консультациядан бас тартуды растау",
  client_consultation_confirm_suggestion_cancellation_text:
    "Ұсынылған консультациядан сәтті бас тарттыңыз. Жаңа консультация жоспарлау үшін {1} кіріңіз.",

  provider_consultation_notify_booking_subject: "Консультацияға жазылу",
  provider_consultation_notify_booking_title: "Жаңа консультацияға жазылу",
  ...
  provider_consultation_confirm_cancellation_subject:
    "Консультацияны болдырмау",
  provider_consultation_confirm_cancellation_title:
    "Консультацияны болдырмауды растау",
  provider_consultation_confirm_cancellation_text:
    "Сіз консультациядан сәтті бас тарттыңыз.",

  provider_consultation_remind_start_subject: "Консультация туралы еске салу",
  provider_consultation_remind_start_title: "Консультация туралы еске салу",
  ...
  provider_report_weekly_subject: "Апта сайынғы есеп",
  provider_report_weekly_title: "Апта сайынғы іс-әрекет есебі",
  provider_report_weekly_text: "Апта сайынғы есепті көру үшін {1} кіріңіз.",

  provider_report_monthly_subject: "Ай сайынғы есеп",
  provider_report_monthly_title: "Ай сайынғы іс-әрекет есебі",
  ...
  month_11: "қараша",
  month_12: "желтоқсан",
  consultation_started_remind_title: "Консультация басталды",
