export default {
  system_forgot_password_subject: "Nie pamiętam hasła",
  ...
  client_consultation_confirm_booking_text:
    "Pomyślnie zarezerwowałeś konsultację. Odwiedź stronę {1}, aby wyświetlić szczegóły konsultacji.",
  client_consultation_confirm_reschedule_subject: "Zmiana terminu konsultacji",
  client_consultation_confirm_reschedule_title:
    "Potwierdzenie zmiany terminu konsultacji",
  client_consultation_confirm_reschedule_text:
    "Pomyślnie przełożyłeś konsultację. Odwiedź stronę {1}, aby wyświetlić szczegóły nowych konsultacji.",
  client_consultation_confirm_cancellation_subject: "Anulowanie konsultacji",
  client_consultation_confirm_cancellation_title:
    "Potwierdzenie anulowania konsultacji",
  client_consultation_confirm_cancellation_text:
    "Pomyślnie anulowałeś swoją konsultację. Odwiedź stronę {1}, aby zaplanować nowy.",

  client_consultation_notify_cancellation_subject: "Anulowanie konsultacji",
  client_consultation_notify_cancellation_title:
    "Konsultacja anulowana przez konsultanta",
  client_consultation_notify_cancellation_text:
    "Konsultacja została anulowana przez konsultanta. Odwiedź stronę {1}, aby zaplanować nowy.",

  client_consultation_remind_start_subject: "Przypomnienie o konsultacjach",
  client_consultation_remind_start_title: "Przypomnienie o konsultacjach",
  client_consultation_remind_start_text:
    "Konsultacja rozpoczyna się za {2} minut. Odwiedź stronę {1}, aby do niej dołączyć.",

  client_consultation_notify_suggestion_subject: "Sugestia konsultacji",
  client_consultation_notify_suggestion_title: "Nowa sugestia konsultacji",
  client_consultation_notify_suggestion_text:
    "Masz nową sugestię dotyczącą konsultacji. Odwiedź stronę {1}, aby wyświetlić więcej szczegółów.",
  ...
  provider_consultation_notify_booking_text:
    "Masz nową rezerwację konsultacji. Odwiedź stronę {1}, aby wyświetlić więcej szczegółów.",

  provider_consultation_notify_reschedule_subject: "Zmiana terminu konsultacji",
  provider_consultation_notify_reschedule_title: "Zmiana terminu konsultacji",
  provider_consultation_notify_reschedule_text:
    "Konsultacja została przełożona. Odwiedź stronę {1}, aby wyświetlić więcej szczegółów.",
  ...
  provider_consultation_confirm_cancellation_text:
    "Pomyślnie anulowałeś konsultację.",

  provider_consultation_remind_start_subject: "Przypomnienie o konsultacjach",
  provider_consultation_remind_start_title: "Przypomnienie o konsultacjach",
  provider_consultation_remind_start_text:
    "Konsultacja rozpoczyna się za {2} minut. Odwiedź stronę {1}, aby do niej dołączyć.",

  provider_consultation_confirm_suggestion_subject: "Sugestia konsultacji",
  provider_consultation_confirm_suggestion_title:
    "Potwierdzenie sugerowanych konsultacji",
  provider_consultation_confirm_suggestion_text:
    "Pomyślnie sugerowałeś konsultację. Odwiedź stronę {1}, aby wyświetlić więcej szczegółów.",

  provider_consultation_notify_suggestion_booking_subject:
    "Rezerwacja konsultacji",
  provider_consultation_notify_suggestion_booking_title:
    "Przyjęta sugestia dotycząca konsultacji",
  provider_consultation_notify_suggestion_booking_text:
    "Twoja sugestia dotycząca konsultacji została zaakceptowana. Odwiedź stronę {1}, aby wyświetlić więcej szczegółów.",
  ...
  provider_consultation_notify_suggestion_cancellation_title:
    "Odrzucona sugestia konsultacji",
  provider_consultation_notify_suggestion_cancellation_text:
    "Twoja sugestia konsultacji została odrzucona przez klienta.",
  ...
  provider_availability_remind_add_more_slots_title:
    "Dodaj więcej dostępnych przedziałów czasowych",
  ...
  consultation_started_remind_title: "Konsultacja rozpoczęla się",
  consultation_started_remind_subject: "Konsultacja rozpoczęla się",
  consultation_started_remind_text:
    "Twoja konsultacja rozpoczęła się. Odwiedź stronę {1}, aby do niej dołączyć.",
