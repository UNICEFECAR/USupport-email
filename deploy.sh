...
then
    ...
    docker build -t email:$IMAGE_TAG .
    docker tag email:$IMAGE_TAG 482053628475.dkr.ecr.eu-central-1.amazonaws.com/usupport-email-api:$IMAGE_TAG

    # Push image to 
    docker push 482053628475.dkr.ecr.eu-central-1.amazonaws.com/usupport-email-api:$IMAGE_TAG
